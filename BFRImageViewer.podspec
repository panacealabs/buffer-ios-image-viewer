Pod::Spec.new do |s|
    ...
    s.description  = <<-DESC
                   ...
                   DESC
    s.homepage      = "https://github.com/panacealabs/buffer-ios-image-viewer"
  	s.screenshot    = "https://github.com/panacealabs/buffer-ios-image-viewer/blob/master/demo.gif?raw=true"
  	s.license       = "MIT"
    ...
    s.source       = { :git => "https://github.com/panacealabs/buffer-ios-image-viewer.git", :tag => '1.2.4'  }
